...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", 
                        default=os.path.join(
                            ttsxai.PACKAGE_DIR,
                            "data/LJSpeech"), 
                        help="Directory of the metadata.csv file")
    parser.add_argument("--save_dir", 
                        default=os.path.join(
                            ttsxai.PACKAGE_DIR,
                            "data_activation/LJSpeech"), 
                        help="Directory to save the activation data")
    ...
    args.save_dir = os.path.join(
        args.save_dir, f'{args.text2mel_type}_{args.mel2wave_type}')
    ...
    for mode in ['train', 'test', 'val']:
        ...
        ljs_metadata_train = read_ljs_metadata(mode=mode)
