# code from: https://github.com/ming024/FastSpeech2
import numpy as np
...
class EnergyCalculatorWrapper(object):
    ...
    def __call__(self, wave):
        _, energy = get_mel_from_wav(wave, self.STFT)
        num_frames = int(wave.shape[0] / self.hop_length)
        energy = energy[:num_frames]
        return energy

    def average_by_duration(self, energy, duration):
